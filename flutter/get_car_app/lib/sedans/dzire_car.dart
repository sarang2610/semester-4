...
class dzire_car extends StatefulWidget {
  const dzire_car({Key? key}) : super(key: key);

  @override
  State<dzire_car> createState() => _dzire_carState();
}

class _dzire_carState extends State<dzire_car> {
  @override
